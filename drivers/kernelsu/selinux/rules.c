...
static int apply_kernelsu_rules_fn(void *ptr)
{
    ...
    /* HyperOS PowerKeeper reads the legacy ODM configuration via /vendor/odm. */
    ksu_allow(db, "system_app", "vendor_file", "lnk_file", "read");
    ksu_allow(db, "system_app", "vendor_file", "lnk_file", "getattr");
    ksu_allow(db, "system_app", "vendor_file", "dir", "search");
    ksu_allow(db, "system_app", "vendor_file", "dir", "getattr");
    ksu_allow(db, "system_app", "vendor_file", "dir", "open");
    ksu_allow(db, "system_app", "vendor_file", "dir", "read");
    ksu_allow(db, "system_app", "vendor_file", "file", "open");
    ksu_allow(db, "system_app", "vendor_file", "file", "read");
    ksu_allow(db, "system_app", "vendor_file", "file", "getattr");
    ksu_allow(db, "system_app", "vendor_file", "file", "map");
